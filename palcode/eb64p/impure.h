/*
 *      VID: [T1.2] PT: [Fri Apr 21 14:23:16 1995] SF: [impure.h]
...
**
**  $Id: impure.h,v 2.4 1995/02/01 16:09:04 samberg Exp $
**
...
#define CNS_Q_BIU_CTL		0x338

#define CNS_Q_SROM_REV          0x340
#define CNS_Q_PROC_ID           0x348
#define CNS_Q_MEM_SIZE          0x350
#define CNS_Q_CYCLE_CNT         0x358
#define CNS_Q_SIGNATURE         0x360
#define CNS_Q_PROC_MASK         0x368
#define CNS_Q_SYSCTX            0x370

#define	CNS_K_SIZE		0x378
...
#define	LAS_Q_BIU_STAT		0x0018
#define	LAS_Q_BIU_ADDR		0x0020
#define	LAS_Q_DC_STAT		0x0028
#define	LAS_Q_FILL_SYNDROME	0x0030
#define	LAS_Q_FILL_ADDR		0x0038
#define	LAS_Q_BC_TAG		0x0040

#define	LAS_K_SIZE		0x0048	/* Frame size */
...
#define LAF_Q_BIU_STAT		0x0168
#define LAF_Q_BIU_ADDR		0x0170
#define LAF_Q_BIU_CTL		0x0178
#define LAF_Q_FILL_SYNDROME	0x0180
#define LAF_Q_FILL_ADDR		0x0188
#define LAF_Q_VA		0x0190
#define LAF_Q_BC_TAG		0x0198

#define LAF_K_SIZE		0x01A0	    /* Frame size */
