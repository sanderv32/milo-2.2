/*
 *      VID: [T1.2] PT: [Fri Apr 21 14:23:15 1995] SF: [platform.h]
...
**
**  $Id: platform.h,v 2.10 1995/04/21 02:18:25 fdh Exp $
**
...
**
** Mikasa specific IRQ pins are
**
**  IRQ0   DC21071-DA   	ipl <= 6
**  IRQ1   EISA Interrupt	ipl <= 2
**  IRQ2   PCI Interrupt	ipl <= 2
**  IRQ3   Reserved
**  IRQ4   RTC			ipl <= 4
**  IRQ5   NMI			ipl <= 6
**
...
#define INT_K_MASK      0x00424262626e6e6e
