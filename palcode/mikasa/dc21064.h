/*
 *      VID: [T1.2] PT: [Fri Apr 21 14:23:11 1995] SF: [dc21064.h]
...
**
**  $Id: dc21064.h,v 2.2 1994/06/16 14:47:31 samberg Rel $
**
...
**	  Loc	Size	Name	    Function
**	 -----	----	----	    ---------------------------------
**	  <15>	  1	DOUBLE_INVAL EV45 - Set to invalidate both D-cache
**				    blocks on assertion of dInvReq_h[0]
...
#define ABOX_V_DOUBLE_INVAL 15
#define ABOX_M_DOUBLE_INVAL (1<<ABOX_V_DOUBLE_INVAL)
