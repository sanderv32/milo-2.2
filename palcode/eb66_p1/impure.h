        //
        // VID: [T1.2] PT: [Fri Apr  1 17:01:00 1994] SF: [impure.h]
 ...
 *
 * Revision 1.1  1995/05/22  09:29:38  rusling
 * PALcode sources for the rev 1 EB66 system.
 *
 * Revision 1.2  1995/03/28  09:22:39  rusling
...
#define CNS$L_BCR0              0x338
#define CNS$L_BCR1              0x33C
#define CNS$L_BCR2              0x340
#define CNS$L_BCR3              0x344
#define CNS$L_BMR0              0x348
#define CNS$L_BMR1              0x34C
#define CNS$L_BMR2              0x350
#define CNS$L_BMR3              0x354

#define CNS$Q_MEM_SIZE          0x358
#define CNS$Q_CYCLE_CNT         0x360
#define CNS$Q_SIGNATURE         0x368
#define CNS$Q_PROC_MASK         0x370
#define CNS$Q_SYSCTX            0x378

#define	CNS$K_SIZE		0x380
...
#define	LAS$Q_ESR		0x0018
#define	LAS$Q_EAR		0x0020
#define	LAS$Q_DC_STAT		0x0028
#define	LAS$Q_IOC_STAT0		0x0030
#define	LAS$Q_IOC_STAT1		0x0038

#define LAS$K_SIZE		0x0040  /* Frame size */
...
#define LAF$Q_ESR		0x0168
#define LAF$Q_EAR		0x0170
#define LAF$Q_CAR		0x0178
#define	LAF$Q_IOC_STAT0		0x0180
#define	LAF$Q_IOC_STAT1		0x0188
#define LAF$Q_VA		0x0190

#define LAF$K_SIZE		0x0198	    /* Frame size */
