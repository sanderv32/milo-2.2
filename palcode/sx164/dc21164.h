/*
 *      VID: [2.0] PT: [Thu Aug 21 16:25:37 1997] SF: [dc21164.h]
...
**
**  $Id: dc21164.h,v 1.19 1997/08/18 18:28:06 fdh Exp $
**
**  MODIFICATION HISTORY:
**
**  $Log: dc21164.h,v $
**  Revision 1.19  1997/08/18  18:28:06  fdh
**  Merged in dc21164pc support.
**
**  Revision 1.18  1997/03/27 17:42:15  fdh
**  Removed the register definition for p3.  This
**  register is reserved for processor status use.
**
**  Revision 1.17  1997/03/26  16:19:36  fdh
**  Added the 21164A Byte/Word Enable bit definitions to the ICSR.
**
**  Revision 1.16  1996/06/17  16:10:31  fdh
**  Added Scache Status Register and External Interface
**  Status Register definitions.
**  Added the BC_K_MCHECK definition.
**  Added the cpu specific STALL definition.
**
...
**	 <19>	 1	MVE	RW,0	Enable Motion Video Instructions DC21164PC
**	 <17>	 1	BSE	RW,0	Byte/Word Enable
**
*/
...
#define ICSR_V_MVE	19
#define ICSR_M_MVE	(1<<ICSR_V_MVE)
#define ICSR_V_BSE	17
#define ICSR_M_BSE	(1<<ICSR_V_BSE)
...
/*
**
**  21164PC Cbox IPR Definitions:
**
*/
#define	bcCfg		0x008	/* RW - Bcache Configuration Parameters */
#define	bcCfg2		0x188	/* RW - Additional Bcache Configuration Parameters */
#define bcStat		0x108	/* RO - Bcache/System Error Status */
#define bcAddr		0x088	/* RO - Bcache/System Error Address */

/*
**
**  Cbox Status Register (BC_STAT) Bit Summary
**
**	 Extent	Size	Name	  	Type	Function
**	 ------	----	----	  	----	---------------------------------
**
*/
#define BCSTAT_V_SYS_CLK_RATIO	4
#define	BCSTAT_M_SYS_CLK_RATIO	(0xF<<BCSTAT_V_SYS_CLK_RATIO)
#define	BCSTAT_V_CHIP_REV		8
#define	BCSTAT_M_CHIP_REV		(0xF<<BCSTAT_V_CHIP_REV)
#define BCSTAT_V_DATA_PAR_ERR	12
#define	BCSTAT_M_DATA_PAR_ERR	(0xF<<BCSTAT_V_DATA_PAR_ERR)
#define	BCSTAT_V_TAG_PAR_ERR	16
#define	BCSTAT_M_TAG_PAR_ERR	(1<<BCSTAT_V_TAG_PAR_ERR)
#define	BCSTAT_V_TAG_DIRTY		17
#define	BCSTAT_M_TAG_DIRTY		(1<<BCSTAT_V_TAG_DIRTY)
#define	BCSTAT_V_MEMORY			18
#define	BCSTAT_M_MEMORY			(1<<BCSTAT_V_MEMORY)
#define	BCSTAT_V_MULTI_ERR		19
#define	BCSTAT_M_MULTI_ERR		(1<<BCSTAT_V_MULTI_ERR)
...
**
*/
#define BC_V_BC_ENA			31
#define BC_M_BC_ENA			(1<<BC_V_BC_ENA)
#define BC_V_BC_TAG_DATA	28
#define BC_M_BC_TAG_DATA	(0x7<<BC_V_BC_TAG_DATA)
#define BC_V_BC_BIG_DRV		27
#define BC_M_BC_BIG_DRV		(1<<BC_V_BC_BIG_DRV)
#define BC_V_BC_FERR		26
#define BC_M_BC_FERR		(1<<BC_V_BC_FERR)
#define BC_V_BC_FHIT		25
#define BC_M_BC_FHIT		(1<<BC_V_BC_FHIT)
#define BC_V_MEM_PAR_ENA	24
#define	BC_M_MEM_PAR_ENA	(1<<BC_V_MEM_PAR_ENA)
#define BC_V_IO_PAR_ENA		23
#define	BC_M_IO_PAR_ENA		(1<<BC_V_IO_PAR_ENA)
#define	BC_V_BC_FILL_DLY	20
#define	BC_M_BC_FILL_DLY	(7<<BC_V_BC_FILL_DLY)
#define	BC_V_PROBE_UNDER_FILL	19
#define	BC_M_PROBE_UNDER_FILL	(1<<BC_V_PROBE_UNDER_FILL)
#define	BC_V_BC_RW_OFF		16
#define	BC_M_BC_RW_OFF		(7<<BC_V_BC_RW_OFF)
#define	BC_V_BC_CLK_DELAY	14
#define BC_M_BC_CLK_DELAY	(3<<BC_V_BC_CLK_DELAY)
#define	BC_V_BC_SIZE		12
#define	BC_M_BC_SIZE		(3<<BC_V_BC_SIZE)
#define	BC_V_LATENCY_OFF	8
#define	BC_M_LATENCY_OFF	(0xF<<BC_V_LATENCY_OFF)
#define	BC_V_CLK_RATIO		4
#define	BC_M_CLK_RATIO		(0xF<<BC_V_CLK_RATIO)

/*
**
**  Bcache Configuration 2 Register (BC_CONFIG2) Bit Summary
**
**	 Extent	Size  Name	    Type  Function
**	 ------	----  ----	    ----  ---------------------------------
**
*/
#define	BC2_V_PM0_MUX		8
#define	BC2_M_PM0_MUX		(7<<BC2_V_PM0_MUX)
#define	BC2_V_PUF_DELAY		7
#define	BC2_M_PUF_DELAY		(1<<BC2_V_PUF_DELAY)
#define	BC2_V_BC_THREE_MISS	6
#define	BC2_M_BC_THREE_MISS	(1<<BC2_V_BC_THREE_MISS)
#define	BC2_V_DBG_SEL		5
#define	BC2_M_DBG_SEL		(1<<BC2_V_DBG_SEL)
#define	BC2_V_BC_REG_REG	4
#define	BC2_M_BC_REG_REG	(1<<BC2_V_BC_REG_REG)
